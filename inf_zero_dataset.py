...
class MyDataset(Dataset):
    def __init__(self,max_time=100,mode=None):
        ...
        if mode == "train":
            self.root_path = "../../../disk2/icchiu/inf_dataset/video_v2/train"
        elif mode == "validation":
            self.root_path = "../../../disk2/icchiu/inf_dataset/video_v2/validation"
        else:
    ...
    def __getitem__(self, idx):
        ...
        begin_img = cv2.resize(begin_img,(512,512))
        end_img = cv2.resize(end_img,(512,512))
        mid_img = cv2.resize(mid_img,(512,512))
